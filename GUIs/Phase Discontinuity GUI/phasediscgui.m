...
% Last Modified by GUIDE v2.5 05-Sep-2016 19:04:05
...
% Hints: get(hObject,'String') returns contents of textin_freq as text
%        str2double(get(hObject,'String')) returns contents of textin_freq as a double
...
% Hints: get(hObject,'String') returns contents of textin_tdur as text
%        str2double(get(hObject,'String')) returns contents of textin_tdur as a double
